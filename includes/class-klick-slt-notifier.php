...
if (class_exists('Klick_Slt_Notifier')) return;

/**
 * Class Klick_Slt_Notifier
 */
class Klick_Slt_Notifier {
	...
	/**
	 * klick_slt_PHP_Notifier constructor
	...
	public function __construct() {
		...
		$folder = opendir(KLICK_SLT_PLUGIN_MAIN_PATH . 'notices');
	...
	public function add_noitice($notice_file) {
		...
		$notice_file = KLICK_SLT_PLUGIN_MAIN_PATH . 'notices' . '/' . $notice_file;
